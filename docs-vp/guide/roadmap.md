...
**Stats:** 97.0% overall token reduction · 1,247 tests passing · 17 MCP tools · 33 languages · 17-language source resolver · 0 npm deps
...
## Current milestone — v8.0 "Evidence Pack & the Pivot" 🚧 IN PROGRESS (E1 in v7.26.0, D3 +2 MCP tools in v7.27.0, E3 `doctor` in v7.28.0, E4 `mcp install` in v7.29.0; next: E2 repositioning · E4 agent recipes)
