...
Seventy-two versions shipped. MIT open source from day one.

**Stats:** 97.0% overall token reduction · 1,219 tests passing · 15 MCP tools · 33 languages · 17-language source resolver · 0 npm deps
...
## Current milestone — v8.0 "Evidence Pack & the Pivot" 🚧 IN PROGRESS (E1 shipped in v7.26.0; next: E2 repositioning · E3 `doctor` · E4 agent recipes + `mcp install` · D3 +2 MCP tools)
