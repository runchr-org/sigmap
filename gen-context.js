#!/usr/bin/env node
'use strict';
// SigMap — standalone bundle (bundled modules generated by scripts/build-bundle.mjs)
...
// ═══ SIGMAP BUNDLED MODULES — generated by scripts/build-bundle.mjs; do not edit by hand ═══
...
// ── ./packages/adapters/willow ──
__factories["./packages/adapters/willow"] = function(module, exports) {
...
__factories["./src/eval/runner"] = function(module, exports) {
   ...
   *
   * Usage (programmatic):
   *   const { run } = __require('./src/eval/src/eval/runner');
...
__factories["./src/format/cache"] = function(module, exports) {
   ...
   *
   * Usage:
   *   const { formatCache } = __require('./src/format/src/format/cache');
...
__factories["./src/graph/builder"] = function(module, exports) {
  ...
  function buildFromCwd(cwd, opts) {
    ...
    let ctx;
    try {
      const { readDescription, collectLocalDefs } = __require('./src/discovery/r-manifest');
...
__factories["./src/map/import-graph"] = function(module, exports) {
  ...
  function extractImports(filePath, content, fileSet) {
    ...
    if (JS_EXTS.has(ext)) {
      ...
      // CommonJS: __require('./src/map/foo')
